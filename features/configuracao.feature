...
E 'Usuario Comum' é o endereço '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266' sem permissões administrativas
...
Dado que 'blocksBetweenSelection' atual é '100'
Quando 'Usuario Comum' tenta chamar 'setBlocksBetweenSelection' com o valor '200'
...
Dado que 'blocksWithoutProposeThreshold' atual é '100'
Quando 'Usuario Comum' tenta chamar 'setBlocksWithoutProposeThreshold' com o valor '50'
Então a transação deve reverter
E a mensagem de erro deve ser 'UnauthorizedAccess'
...
Dado que 'nextSelectionBlock' atual é '100'
Quando 'Usuario Comum' tenta chamar 'setNextSelectionBlock' com o valor '200'
Então a transação deve reverter
E a mensagem de erro deve ser 'UnauthorizedAccess'